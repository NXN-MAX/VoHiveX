...
| jsQR | [1.4.0](https://github.com/cozmo/jsQR/tree/v1.4.0) | Apache-2.0；Copyright (c) 2017 Cosmo Wolfe；`app/proxy/vendor/LICENSE.jsQR`；依赖锁定见 `app/build-tools/package-lock.json` |
...
| Remix Icon | [固定源码提交](https://github.com/Remix-Design/RemixIcon/tree/9fb7967c0a4c09910161192bde99efd3df09f5eb) | Remix Icon License v1.0；Copyright (c) 2017–2026 Remix Design；SVG、许可与来源记录见 `app/frontend/remixicon/` |
