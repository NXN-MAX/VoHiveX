...
# The Go gateway and durable scheduler use the same restricted capabilities.
setpriv --bounding-set=-sys_module,-setpcap --inh-caps=-all --ambient-caps=-all \
  --no-new-privs /opt/vohivex/vohivex-gateway & scheduler_pid=$!
