...
const contacts = [
  { peer: '+86 188 0000 2001', device_id: 'DJI26123', device_name: devices[0].name, imsi: devices[0].imsi, local_phone: devices[0].msisdn, last_content: 'Your scheduled test message was received.', last_timestamp: new Date(Date.now() - 90_000).toISOString(), unread_count: 1 },
  { peer: '10086', device_id: 'DJI26123', device_name: devices[0].name, imsi: devices[0].imsi, local_phone: devices[0].msisdn, last_content: 'Demo account balance notification', last_timestamp: new Date(Date.now() - 3_600_000).toISOString(), unread_count: 0 },
  ...Array.from({ length: 10 }, (_, index) => ({ peer: `+86 166 0000 ${String(3000 + index)}`, device_id: 'DJI26123', device_name: devices[0].name, imsi: devices[0].imsi, local_phone: devices[0].msisdn, last_content: `Example conversation ${index + 1}`, last_timestamp: new Date(Date.now() - (index + 2) * 7_200_000).toISOString(), unread_count: index % 3 === 0 ? 1 : 0 })),
]
const sms = [
